...
#
# Created: Wed May 28 17:14:25 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.openCameraWindow)
        QtCore.QObject.connect(self.pushButton_4, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.close)
        QtCore.QObject.connect(self.pushButton_2, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.openSetupDialog)
        QtCore.QObject.connect(self.pushButton_3, QtCore.SIGNAL(_fromUtf8("clicked()")), MainWindow.startProfile)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow", None))
        self.label.setText(_translate("MainWindow", "Clocking:", None))
        self.label_4.setText(_translate("MainWindow", "10°", None))
        self.label_31.setText(_translate("MainWindow", "z (mm)", None))
        self.label_32.setText(_translate("MainWindow", "3", None))
        self.label_33.setText(_translate("MainWindow", "3", None))
        self.label_34.setText(_translate("MainWindow", "y-Ø (mm)", None))
        self.label_35.setText(_translate("MainWindow", "3", None))
        self.label_36.setText(_translate("MainWindow", "x-Ø (mm)", None))
        self.pushButton.setText(_translate("MainWindow", "Camera", None))
        self.pushButton_2.setText(_translate("MainWindow", "Setup", None))
        self.pushButton_3.setText(_translate("MainWindow", "Start Profile", None))
        self.pushButton_4.setText(_translate("MainWindow", "Exit", None))
        self.label_11.setText(_translate("MainWindow", "Ø (mm)", None))
        self.label_12.setText(_translate("MainWindow", "DOF (mm)", None))
        self.label_13.setText(_translate("MainWindow", "z (mm)", None))
        self.label_2.setText(_translate("MainWindow", "Major Axis:", None))
        self.label_5.setText(_translate("MainWindow", "3", None))
        self.label_7.setText(_translate("MainWindow", "3", None))
        self.label_9.setText(_translate("MainWindow", "3", None))
        self.label_3.setText(_translate("MainWindow", "Minor Axis:", None))
        self.label_6.setText(_translate("MainWindow", "3", None))
        self.label_8.setText(_translate("MainWindow", "3", None))
        self.label_10.setText(_translate("MainWindow", "3", None))
        self.label_25.setText(_translate("MainWindow", "z (mm)", None))
        self.label_30.setText(_translate("MainWindow", "3", None))
        self.label_26.setText(_translate("MainWindow", "3", None))
        self.label_29.setText(_translate("MainWindow", "y-Ø (mm)", None))
        self.label_27.setText(_translate("MainWindow", "3", None))
        self.label_28.setText(_translate("MainWindow", "x-Ø (mm)", None))
